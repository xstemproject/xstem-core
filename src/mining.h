// Copyright (c) 2017-2018 XSTEM DEV TEAM
// Copyright (c) 2018 XSTEM project
...
inline int64_t MasternodeCollateral(int nHeight) { return 10000; } // 10K XSTEM required as collateral
