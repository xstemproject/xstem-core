...
static const int64_t MAX_SINGLE_TX = 100000000 * COIN; // 100 Million XStem coins
/** Moneyrange params */
...
bool AcceptToMemoryPool(CTxMemPool& pool, CTransaction &tx, bool fLimitFree,
                        bool* pfMissingInputs, bool fRejectXstemFee=false, bool ignoreFees=false);

bool AcceptableInputs(CTxMemPool& pool, const CTransaction &txo, bool fLimitFree,
                        bool* pfMissingInputs, bool fRejectXstemFee=false, bool isDSTX=false);
...
public:
    ...
    bool AcceptToMemoryPool(bool fLimitFree=true, bool fRejectXstemFee=true, bool ignoreFees=false);
