...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XTE");
    case mBTC: return QString("mXTE");
    case uBTC: return QString::fromUtf8("μXTE");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XStems");
    case mBTC: return QString("Milli-XStems (1 / 1,000)");
    case uBTC: return QString("Micro-XStems (1 / 1,000,000)");
    default: return QString("???");
    }
}
